...
const FormAddIngredients = ({ submitForm }) => {
  ...
  return (
    <form className="p-7 bg-[#43035f] overflow-y-auto min-h-[200px] shadow-[8px_8px_15px_5px_rgba(0,0,0,0.6)] md:w-[550px]" method="post" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-row items-center gap-3">
        <button className="bg-[#8a00c4] p-1 text-[14px] md:p-3 md:text-[16px] rounded-lg text-white cursor-pointer hover:bg-[#9e2fce]" type="button" onClick={() => setIngredients([...ingredients, ""])}>Nuevo ingrediente</button>
        
        <button className="bg-[#41c398] p-1 text-[14px] md:p-3 md:text-[16px] rounded-lg text-white cursor-pointer hover:bg-[#38ac85]" type="submit">Agregar ingredientes</button>
      </div>
